...
export const User = () => {
     ...
     return (
          <>
               {/* <div className=""> */}
                    <form  action="" className="text-center mt-5   w-75   " style={{color:"#5F9EA0",marginLeft:"500px",height:"450px"}}>
                    <table border="0" className="w-50">
                      ...
                      <tr>
                        ...
                        <tr>
                          <td><label htmlFor="Add" className=" fw-bold mt-3" style={{paddingLeft:"130px"}} >Address : </label></td>
                          <td><input type="text" id="Add" name="Add" required className="border border-1 fw-bold text-center" value={info.Add} onChange={Handlechange} placeholder="Enter your Address" /></td>
                        </tr>
                        <tr>
